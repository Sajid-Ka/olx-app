        ...
        <div>
            <Modal theme={{
                ...
                <div onClick={(e) => e.stopPropagation()} className="p-6 pl-2 pr-2 bg-white">
                    ...
                    <Carousel slide={false} theme={{
                    ...
                    }} onClick={(e) => e.stopPropagation()} className="w-full h-56 pb-5 rounded-none">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p style={{color: "#002f34"}} className="w-60 sm:w-72 text-center pb-5 font-semibold">Keep all your favourites in one place.</p>
                        </div>
                    </Carousel>
                </div>

                <ModalBody className="bg-white h-96 p-0 rounded-none" onClick={(e) => e.stopPropagation()}>
                    <div className="p-6 pt-0">
                        <div className="flex items-center justify-center rounded-md border-2 border-solid border-gray-300 p-5 pl-4 relative h-8 mb-4">
                        ...
                        <div className="pt-10 sm:pt-20 flex flex-col items-center justify-center">
                            ...
                            <p className="text-xs pt-5 text-center">If you continue, you are accepting OLX Terms and Conditions and Privacy Policy</p>
                        </div>
                    </div>
                </ModalBody>
            </Modal>
