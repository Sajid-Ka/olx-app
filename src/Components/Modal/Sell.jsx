...
const Sell = ({toggleModalSell,status,setItems}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(image){
            try {
                imageUrl = await readImgaeAsDataUrl(image)
            } catch (error) {
                console.log(error);
        ...
        <div>
            ...
            <Modal theme={{
                ...
                <ModalBody className="bg-white h-96 p-0 rounded-md" onClick={(e) => e.stopPropagation()} >
                    ...
                    <div className="p6 pl-8 pr-8 pb-8">
                                ...
                                {image ? (
                                    ...
                                    <div className="relative h-40 sm:h-60 w-full border-2 border-black border-solid rounded-md">
                                        <input 
                                            ...
                                            type="file" 
                                            className="absolute inset-10 h-full w-full opacity-0 cursor-pointer" 
                                            required
                                        />
