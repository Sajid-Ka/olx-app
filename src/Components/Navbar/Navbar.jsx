      ...
      <nav className="fixed z-50 w-full p-2 pl-3 pr-3 shadow-md bg-slate-100 border-b-4 border-solid border-b-white flex items-center justify-between">
        ...
        <div className="ml-5 mr-2 relative w-full main-search">
          <input
            ...
            className="w-[100%] p-3 border-black border-solid border-2 rounded-md placeholder:text-ellipsis focus:outline-none focus:border-teal-300"
          />
          <div
        ...
        <Link to="/favorites">
          <img
            src={favorite}
            alt="Favorite Icon"
            className="w-5 mx-6 cursor-pointer"
          />
        </Link>
        ...
        {!user ? (
          <p
            ...
            style={{ color: "#002f34", textUnderlineOffset: "4px" }}
            onClick={toggleModal}
          >
            Login
          </p>
        ) : (
          <div className="relative flex items-center ml-5 cursor-pointer" onClick={toggleModalLogout}>
            <img
              src={avatar}
              alt="User Avatar"
            ...
            <img
              src={arrow}
              alt="Dropdown Arrow"
              className="w-4 ml-1 mr-8 cursor-pointer"
              onClick={toggleModalLogout}
            />
          </div>
        )}
        ...
        <img
          src={addBtn}
          alt=""
          className="w-24 mx-1 sm:ml-5 sm:mr-2 shadow-xl rounded-full cursor-pointer"
      ...
      <div className="w-full relative z-10 flex shadow-md p-2 pt-20 pl-10 pr-10 sm:pl-44 md:pr-44 sub-lists fixed">
        <ul className="list-none flex items-center justify-center w-full">
          <div className="flex flex-shrink-0">
            ...
            <li className="px-2.5">Cars</li>
            <li className="px-2.5">Motorcycles</li>
            <li className="px-2.5">Mobile Phones</li>
            <li className="px-2.5">For Sale: Houses & Apartments</li>
            <li className="px-2.5">Scooters</li>
            <li className="px-2.5">Commercial & Other Vehicles</li>
            <li className="px-2.5">For Rent: Houses & Apartments</li>
          </div>
        </ul>
      </div>
    </div>
